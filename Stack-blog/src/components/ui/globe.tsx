...
export function Globe({ globeConfig, data }: WorldProps) {
  ...
  useEffect(() => {
    ...
    // Process points from articles with coordinates
    const points = data.map(point => ({
      lat: point.lat,
      lng: point.lng,
      size: point.size || defaultProps.pointSize,
      color: point.color,
      // Store article data for tooltips/clicks
    ...
    // Set up points data (no arcs for blog globe)
    globeRef.current
      .pointsData(points)
